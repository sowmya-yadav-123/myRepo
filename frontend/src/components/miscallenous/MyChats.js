...
fetchChats();},[fetchAgain])
  return (
      ...
      alignItems={"center"}
      p={3}
      backgroundImage={"linear-gradient(yellow,cyan,rgb(300, 45, 18),white,green,pink,purple)"}
      w={{base:"100%",md:"30%"}}
      borderRadius={"lg"}
      borderWidth={"1.5px"}
      >
       ...
       <GroupChatModal><Button
        ...
        flexDir={"column"}
        p={3}
        backgroundImage={"linear-gradient(#ff8928,beige,white,#ff414e,#ffffff,#f95d9b)"}
        w="100%"
        h="100%"
        borderRadius={"lg"}
        overflowY={"hidden"}
